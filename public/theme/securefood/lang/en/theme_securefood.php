...
$string['aboutfeed_desc'] = 'Manual fallback JSON list, e.g. [{"chip": "Digital twin", "title": "…", "text": "…", "time": "2 days ago", "variant": "twin"}]. Moodle WS live data takes priority when enabled and available. Leave empty to hide the feed until real data is supplied.';
$string['aboutfeedwsheading'] = 'Latest from the network Moodle WS';
$string['aboutfeedwsheading_desc'] = 'Allow an external service to replace the About-page feed cards through Moodle External Services API.';
$string['aboutfeedwsendpoint'] = 'Moodle WS function';
$string['aboutfeedwsendpoint_desc'] = 'Call <code>{$a->endpoint}</code> with <code>wsfunction={$a->function}</code>, a valid Moodle webservice token for a user with <code>moodle/site:config</code>, and <code>moodlewsrestformat=json</code>. Required parameter: <code>items</code>; each item may include <code>chip</code>, <code>title</code>, <code>text</code>, <code>time</code>, <code>variant</code> and <code>url</code>.';
$string['aboutfeedwsenabled'] = 'Enable network feed WS updates';
$string['aboutfeedwsenabled_desc'] = 'Allow the Moodle web service function to replace the live About feed. Access is still controlled by Moodle webservice tokens and the moodle/site:config capability.';
$string['aboutfeedwsmaxitems'] = 'Maximum live feed cards';
$string['aboutfeedwsmaxitems_desc'] = 'How many cards from the external service to store and render. Values above 12 are capped.';
$string['aboutfeeduselive'] = 'Use live feed data when available';
$string['aboutfeeduselive_desc'] = 'Render the latest accepted Moodle WS payload before the manual fallback JSON. If both are empty, the feed is hidden.';
$string['feedwsdisabled'] = 'The SecureFood network feed web service is disabled.';
$string['abouthubstitle'] = 'About page — hubs heading';
$string['abouthubs'] = 'About page — Living Labs & partners (JSON)';
$string['abouthubs_desc'] = 'JSON list, e.g. [{"name": "Kyiv Lab", "country": "Ukraine", "type": "lab", "lat": 50.45, "lon": 30.52}]. "type" is "lab" or "partner". Add numeric "lat" and "lon" to place the point on the map — an entry without coordinates still shows in the list but not on the map. Leave empty for the design defaults.';
...
$string['hub_password_desc'] = 'Update the password you use to sign in.';
$string['hub_notifications_desc'] = 'Choose which updates you receive and how.';
$string['hub_privacy_desc'] = 'Review your data requests and privacy preferences.';
...
$string['abouthubsnetworktitle'] = 'About page — network panel heading';
$string['abouthubsnetworklede'] = 'About page — network panel description';
$string['aboutdefault_hubsnetworktitle'] = 'Network';
$string['aboutdefault_hubsnetworklede'] = 'SecureFood spans partners across the EU and Ukraine — research institutes, food industries, NGOs and innovators. Select a row to focus the map.';
