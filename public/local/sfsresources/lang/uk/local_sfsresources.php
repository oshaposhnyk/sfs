...
$string['documents_desc'] = 'JSON-список, напр. [{"title": "HACCP Protocol", "sub": "Cold chain", "audience": "Director", "kind": "pdf", "updated": "2 дні тому", "url": "https://…"}]. "kind" — pdf, doc, xls, zip або link. Порожнє поле — типові значення дизайну.';
...
$string['stats_desc'] = 'JSON-список, напр. [{"label": "Персонал навчено", "value": "145", "suffix": "", "percent": 72, "sub": "Завершені курси L4C", "variant": "teal"}]. "variant" — teal, amber або deep. Порожнє поле — типові значення дизайну.';
