...
$string['plan:view:renamestage'] = 'Rename stage';
$string['stage:renamed'] = 'Stage renamed.';
$string['error:emptystagename'] = 'The stage name cannot be empty.';
$string['error:stagenotfound'] = 'That stage is not part of this plan.';
$string['error:stagenameexists'] = 'A stage with that name already exists in this plan.';
