...
$string['settings:studentlabheading'] = 'Сторінка Student Lab';
$string['settings:studentlabheading_desc'] = 'No-code керування студентською сторінкою Student Lab. Порожні текстові налаштування використовують типові тексти дизайну.';
$string['settings:showstudentlabheader'] = 'Показувати заголовок Student Lab';
$string['settings:showstudentlabheader_desc'] = 'Відображати надзаголовок, заголовок і вступний текст угорі Student Lab.';
$string['settings:showstudentlabcontinue'] = 'Показувати кнопку продовження навчання';
$string['settings:showstudentlabcontinue_desc'] = 'Відображати CTA «Продовжити навчання», коли в учня є доступний наступний курс.';
$string['settings:showstudentlabplanbar'] = 'Показувати панель активного плану';
$string['settings:showstudentlabplanbar_desc'] = 'Відображати вибір активного навчального плану, лічильники й прогрес.';
$string['settings:showstudentlabstages'] = 'Показувати етапи курсів';
$string['settings:showstudentlabstages_desc'] = 'Відображати сітку етапів і карток курсів.';
$string['settings:studentlabkicker'] = 'Student Lab — надзаголовок';
$string['settings:studentlabtitle'] = 'Student Lab — заголовок';
$string['settings:studentlablede'] = 'Student Lab — вступний текст';
$string['settings:studentlabempty'] = 'Student Lab — повідомлення без планів';
$string['settings:studentlabnocourses'] = 'Student Lab — повідомлення без курсів';
$string['settings:studentlabfallback_desc'] = 'Порожнє поле використовує типовий текст Student Lab.';
...
$string['course:stageupdated'] = 'Етап оновлено.';
$string['course:notinplan'] = 'Цей курс не входить до плану.';
$string['plan:view:savestage'] = 'Зберегти етап';
$string['plan:view:renamestage'] = 'Перейменувати етап';
$string['stage:renamed'] = 'Етап перейменовано.';
$string['error:emptystagename'] = 'Назва етапу не може бути порожньою.';
$string['error:stagenotfound'] = 'Цей етап не належить цьому плану.';
$string['error:stagenameexists'] = 'Етап з такою назвою вже існує в цьому плані.';
$string['plan:view:nostage'] = 'Без етапу';
$string['plan:view:stagecount'] = 'Курсів: {$a}';
$string['plan:view:stageplaceholder'] = 'напр. Етап 1 · Основи';
