...
/**
 * Reorder plan courses use case.
 */
final class reorder_learning_plan_courses {
     ...
     * @return void
     */
    public function execute(int $planid, int $courseid, int $direction, int $actorid): void {
        $this->service->move_course($planid, $courseid, $direction, $actorid);
    }
}
