...
/**
 * Create learning plan use case.
 */
final class create_learning_plan {
    ...
    public function execute(
        ...
        return $this->service->create_plan($name, $description, $enabled, $sequentialmode, $enrolmentmode, $actorid);
    }
}
