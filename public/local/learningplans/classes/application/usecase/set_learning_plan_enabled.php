...
/**
 * Archive/activate plan use case.
 */
final class set_learning_plan_enabled {
     ...
     */
    public function execute(int $planid, bool $enabled, int $actorid): learning_plan {
        return $this->service->set_plan_enabled($planid, $enabled, $actorid);
    }
}
