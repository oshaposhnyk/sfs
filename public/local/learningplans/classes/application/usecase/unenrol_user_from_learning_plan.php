...
/**
 * Unenrol user from plan use case.
 */
final class unenrol_user_from_learning_plan {
     ...
     * @return void
     */
    public function execute(int $planid, int $userid, int $actorid): void {
        $this->service->unenrol_user($planid, $userid, $actorid);
    }
}
