...
/**
 * Delete learning plan use case.
 */
final class delete_learning_plan {
     ...
     * @return void
     */
    public function execute(int $planid, int $actorid): void {
        $this->service->delete_plan($planid, $actorid);
    }
}
