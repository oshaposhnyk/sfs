...
/**
 * Recalculate user plan progress use case.
 */
final class recalculate_learning_plan_progress {
     ...
     * @return progress
     */
    public function execute(int $planid, int $userid, int $actorid = 0): progress {
        return $this->service->recalculate_progress($planid, $userid, $actorid);
    }
}
