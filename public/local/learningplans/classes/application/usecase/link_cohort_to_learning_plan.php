...
/**
 * Link a cohort to a learning plan.
 */
final class link_cohort_to_learning_plan {
     ...
     */
    public function execute(int $planid, int $cohortid, int $actorid): bool {
        return $this->service->link_cohort($planid, $cohortid, $actorid);
    }
}