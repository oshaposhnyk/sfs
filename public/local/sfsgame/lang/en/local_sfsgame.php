...
$string['settings:xpheading'] = 'XP economy';
$string['settings:xpheading_desc'] = 'Tune how much XP each source is worth and how much XP a level takes.';
$string['setting:xpperbadge'] = 'XP per badge';
$string['setting:xpperbadge_desc'] = 'XP awarded for each earned achievement badge. Default 100.';
$string['setting:xppercourse'] = 'XP per completed course';
$string['setting:xppercourse_desc'] = 'XP awarded for each completed plan course (counted once). Default 50.';
$string['setting:xpperlevel'] = 'XP per level';
$string['setting:xpperlevel_desc'] = 'XP needed to advance one rank/level. Default 500.';
$string['setting:badgexp'] = 'Per-badge XP (JSON)';
$string['setting:badgexp_desc'] = 'Optional JSON mapping of badge name to XP, e.g. {"Guardian": 25, "Eco Pioneer": 30}. Badges not listed use the flat XP per badge above.';
...
$string['missions_desc'] = 'Add, edit or remove mission cards. To award the configured XP the URL must point to a Moodle activity (an /mod/… link, e.g. a quiz or page) that has completion enabled — the learner earns the XP when they complete that activity. A course link (/course/view.php) or an external URL still shows the card, but its XP is never awarded, so the "+XP" is hidden on those cards.';
...
$string['missionprogress'] = '{$a}% complete';
