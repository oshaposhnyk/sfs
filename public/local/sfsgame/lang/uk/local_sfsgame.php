...
$string['missions_desc'] = 'Додавайте, редагуйте або видаляйте відео/активності. Внутрішні URL Moodle-активностей з увімкненим completion можуть нараховувати налаштований XP після завершення; зовнішні URL вважаються лише ресурсами.';
