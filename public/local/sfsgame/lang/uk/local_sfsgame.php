...
$string['settings:xpheading'] = 'Економіка XP';
$string['settings:xpheading_desc'] = 'Налаштуйте, скільки XP дає кожне джерело та скільки XP потрібно на рівень.';
$string['setting:xpperbadge'] = 'XP за бейдж';
$string['setting:xpperbadge_desc'] = 'XP за кожен зароблений бейдж-досягнення. Типово 100.';
$string['setting:xppercourse'] = 'XP за завершений курс';
$string['setting:xppercourse_desc'] = 'XP за кожен завершений курс плану (рахується один раз). Типово 50.';
$string['setting:xpperlevel'] = 'XP на рівень';
$string['setting:xpperlevel_desc'] = 'Скільки XP потрібно для наступного рангу/рівня. Типово 500.';
$string['setting:badgexp'] = 'XP за окремі бейджі (JSON)';
$string['setting:badgexp_desc'] = 'Необовʼязковий JSON-мапінг назви бейджа на XP, напр. {"Guardian": 25, "Eco Pioneer": 30}. Бейджі поза списком беруть загальний «XP за бейдж» вище.';
